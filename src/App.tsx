...
function SettingsView({ notify }: any) {
  const [status, setStatus] = useState<any>(null); const [keys, setKeys] = useState({ openai: '', gemini: '', gcp: '', freesound: '' }); const [busy, setBusy] = useState('');
